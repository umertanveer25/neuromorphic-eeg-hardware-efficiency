...
> Official Repository for **"Sub-Microjoule Event-Driven Spiking Neural Networks for Responsive Neurostimulation: Hardware-Software Co-Design for Patient-Independent EEG Seizure Detection"** by **Umer Tanveer** and **Hali KFS** (2026).
...
@article{tanveer2026neuromorphic,
  author    = {Tanveer, Umer and KFS, Hali},
